      ...
      <header className="mb-8 sm:mb-10 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
          <button
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-gradient-to-r from-primary_container to-primary text-on_primary_fixed font-semibold px-5 py-3 rounded-2xl shadow-[0_8px_30px_-10px_rgb(var(--primary-green-rgb)/0.32)] hover:brightness-110 transition-all disabled:opacity-50"
          >
