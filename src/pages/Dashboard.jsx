    ...
    <div className="animate-fade-in pb-10">
      <header className="mb-8 sm:mb-10 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        ...
        <Link
          ...
          className="w-full sm:w-auto justify-center bg-gradient-to-r from-primary_container to-primary text-on_primary_fixed font-semibold px-6 py-3 rounded-2xl flex items-center gap-2 shadow-[0_8px_30px_-10px_rgba(115,209,29,0.32)] hover:brightness-110 hover:scale-[1.02] transition-all"
        >
        ...
        <div className="xl:col-span-4 bg-surface_container border border-outline_variant/10 rounded-[1.5rem] p-6 sm:p-8 flex flex-col justify-between">
          ...
          <div className="mt-6">
            ...
            <div className="w-full bg-surface_container_highest h-2 rounded-full overflow-hidden">
              <div
                className="bg-primary h-full rounded-full shadow-[0_0_10px_rgba(130,215,47,0.58)] transition-all"
