      ...
      <header className="sticky top-0 z-30 border-b border-outline_variant/25 bg-white/84 backdrop-blur-xl">
        <div className="mx-auto max-w-7xl px-4 py-3 sm:px-6">
          <div className="flex items-center justify-between gap-3">
            <Link to="/portal" className="shrink-0 rounded-2xl border border-outline_variant/15 bg-white/85 px-3 py-2 shadow-[0_12px_24px_-20px_rgb(var(--bg-main-rgb)/0.18)]">
                  ...
                  return (
                    <Link
                      ...
                      className={`flex items-center gap-2 rounded-2xl border px-4 py-2.5 text-sm font-medium transition-colors ${
                        isActive
                          ? 'border-primary/20 bg-primary/10 text-on_surface shadow-[0_10px_22px_-18px_rgb(var(--primary-green-rgb)/0.24)]'
