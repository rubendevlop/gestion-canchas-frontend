  ...
  return (
    ...
    >
      <div className="flex items-center gap-4">
        <div className="flex h-16 w-16 items-center justify-center rounded-full border border-brand_white/45 bg-brand_white/15 shadow-[0_0_0_10px_rgba(248,248,248,0.12)]">
